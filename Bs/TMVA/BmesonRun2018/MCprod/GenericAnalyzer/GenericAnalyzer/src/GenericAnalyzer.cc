...
GenericAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  if(doGenParticle_){
    ...
    bool GetXSignal = false;
    bool GetPsi2SSignal = false;
    ////My analysis
      ...
      // if(abs(pdg) == 9940023){
        ...
        if(ndau != 0){
          for(int i = 0; i < ndau; i++){
            ...
            cout<<"\e[32;1m"<< "   daughter: " << MyDau->pdgId() <<" => "<<MyDau->mass() << " / " << MyDau->status() <<" / "<<MyDau->pt()<<" / "<<ndaudau<<"\e[0m"<<endl;
        ...
        if(p.numberOfDaughters()==3)
          if(abs(p.daughter(0)->pdgId()) == 443)
            if(p.daughter(0)->numberOfDaughters()>1)
              if(abs(p.daughter(0)->daughter(0)->pdgId())==13)
                if(abs(p.daughter(0)->daughter(1)->pdgId())==13)
                  if(abs(p.daughter(1)->pdgId()) == 211 && abs(p.daughter(2)->pdgId()) == 211) 
                    {
                      Bpt->Fill(p.pt());
                      Beta->Fill(p.eta());
                      Bspt->Fill(p.pt());
    ...
    if(GetGammaSignal) cout<<"\e[32;2mGetGammaSignal\e[0m"<<endl;
    else cout<<"\e[31;2mNoGammaSignal\e[0m"<<endl;
    if(GetD0Signal) cout<<"\e[32;2mGetD0Signal\e[0m"<<endl;
    else cout<<"\e[31;2mNoD0Signal\e[0m"<<endl;
    if(GetDsSignal) cout<<"\e[32;2mGetDsSignal\e[0m"<<endl;
    else cout<<"\e[31;2mNoDsSignal\e[0m"<<endl;
    if(GetBpSignal) cout<<"\e[32;2mGetBpSignal\e[0m"<<endl;
    else cout<<"\e[31;2mNoBpSignal\e[0m"<<endl;
    if(GetB0Signal) cout<<"\e[32;2mGetB0Signal\e[0m"<<endl;
    else cout<<"\e[31;2mNoB0Signal\e[0m"<<endl;
    if(GetBsSignal) cout<<"\e[32;2mGetBsSignal\e[0m"<<endl;
    else cout<<"\e[31;2mNoBsSignal\e[0m"<<endl;
    if(GetXSignal) cout<<"\e[32;2mGetXSignal\e[0m"<<endl;
    else cout<<"\e[31;2mNoXSignal\e[0m"<<endl;
    if(GetPsi2SSignal) cout<<"\e[32;2mGetPsi2SSignal\e[0m"<<endl;
    else cout<<"\e[31;2mNoPsi2SSignal\e[0m"<<endl;
  }
