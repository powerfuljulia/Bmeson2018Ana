...
TString Var[NVar] = {"Balpha","BsvpvDistance/BsvpvDisErr","Bchi2cl","BDT_pt_7_15","BDT_pt_15_20","BDT_pt_20_50","abs(Btrk1DxyError1/Btrk1Dxy1)","abs(Btrk2Dxy1/Btrk2DxyError1)","abs(Btrk1DzError1/Btrk1Dz1)","abs(Btrk2Dz1/Btrk2DzError1)"}; 
...
int CutValueXBin;
double VarCutMin[NVar] = {0.02,2.0,0.10,-0.30,-0.30,-0.30,0,0,0,0};
double VarCutMax[NVar] = {0.60,18.0,0.40,0.60,0.60,0.60,10,10,10,10};
int NCut[NVar] = {10,10,10,10,10,10,10,10,10,10};
double NVarStep[NVar];


double VarHisMin[NVar] = {0.00,0,0.00,-1.0,-1.0,-1.0,0,0,0,0};
double VarHisMax[NVar] = {1.00,20.0,1.00,1.0,1.0,1.0,10,10,10,10};
