...
//	TF1 *f = new TF1(Form("f%d",count),"[0]*([7]*Gaus(x,[1],[2])/(sqrt(2*3.14159)*[2])+(1-[7])*([9]*Gaus(x,[1],[8])/(sqrt(2*3.14159)*[8])+(1-[9])*Gaus(x,[1],[10])/(sqrt(2*3.14159)*[10])))+[3]+[4]*x+[5]*x*x+[11]*("+iNP+")");
	...
	TF1 *f = new TF1(Form("f%d",count),"[0]*([7]*Gaus(x,[1],[2]*(1+[12]))/(sqrt(2*3.14159)*[2]*(1+[12]))+(1-[7])*([9]*Gaus(x,[1],[8]*(1+[12]))/(sqrt(2*3.14159)*[8]*(1+[12]))+(1-[9])*Gaus(x,[1],[10]*(1+[12]))/(sqrt(2*3.14159)*[10]*(1+[12]))))+[3]+[4]*x+[5]*x*x+[6]*x*x*x");
	...
	TF1 *mass = new TF1(Form("fmass%d",count),"[0]*([3]*Gaus(x,[1],[2]*(1+[7]))/(sqrt(2*3.14159)*[2]*(1+[7]))+(1-[3])*([5]*Gaus(x,[1],[4]*(1+[7]))/(sqrt(2*3.14159)*[4]*(1+[7]))+(1-[5])*Gaus(x,[1],[6]*(1+[7]))/(sqrt(2*3.14159)*[6]*(1+[7]))))");
