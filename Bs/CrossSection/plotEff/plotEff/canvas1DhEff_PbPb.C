...
//=========  (Tue Feb 12 10:45:01 2019) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.001183432);
   hEff2->SetBinContent(2,0.01517915);
   hEff2->SetBinContent(3,0.09040544);
   hEff2->SetBinContent(4,0.1817481);
   hEff2->SetBinError(1,0.0004167682);
   hEff2->SetBinError(2,0.001491822);
   hEff2->SetBinError(3,0.00334892);
   hEff2->SetBinError(4,0.01238227);
   hEff2->SetEntries(837.2997);
   hEff2->SetStats(0);
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.9,0.92,"351 #mub^{-1} (5.02 TeV PbPb)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
   tex->SetTextSize(0.038);
