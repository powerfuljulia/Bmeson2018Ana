...
//=========  (Tue Feb 12 10:28:36 2019) by ROOT version6.02/13
   ...
   hEff2->SetBinContent(1,0.005702098);
   hEff2->SetBinContent(2,0.04721835);
   hEff2->SetBinContent(3,0.158592);
   hEff2->SetBinContent(4,0.1690964);
   hEff2->SetBinError(1,0.0001161135);
   hEff2->SetBinError(2,0.000398563);
   hEff2->SetBinError(3,0.0007446169);
   hEff2->SetBinError(4,0.001797877);
   hEff2->SetEntries(61555.02);
   hEff2->SetStats(0);
