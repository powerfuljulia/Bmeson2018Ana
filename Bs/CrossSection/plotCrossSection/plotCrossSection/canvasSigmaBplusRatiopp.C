...
//=========  (Tue Feb 12 10:28:39 2019) by ROOT version6.02/13
...
// ------------>Primitives in pad: pSigma
   ...
   TH1F *Graph_gaeCrossSyst3002 = new TH1F("Graph_gaeCrossSyst3002","Graph",100,0,55);
   Graph_gaeCrossSyst3002->SetMinimum(7523.812);
   Graph_gaeCrossSyst3002->SetMaximum(588537.6);
...
// ------------>Primitives in pad: pRatio
   ...
   TH1F *Graph_gaeRatioCrossFONLLunity3003 = new TH1F("Graph_gaeRatioCrossFONLLunity3003","Graph",100,0,55);
   ...
   TH1F *Graph_gaeRatioCrossFONLLstat3004 = new TH1F("Graph_gaeRatioCrossFONLLstat3004","Graph",100,0,55);
   Graph_gaeRatioCrossFONLLstat3004->SetMinimum(0);
   Graph_gaeRatioCrossFONLLstat3004->SetMaximum(inf);
   ...
   TH1F *Graph_gaeRatioCrossFONLLsyst3005 = new TH1F("Graph_gaeRatioCrossFONLLsyst3005","Graph",100,0,55);
   Graph_gaeRatioCrossFONLLsyst3005->SetMinimum(0);
   Graph_gaeRatioCrossFONLLsyst3005->SetMaximum(inf);
