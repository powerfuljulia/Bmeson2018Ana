	...
	// std::vector<std::string> signal = {"3gauss", "fixed", "scal", "perr", "merr", "scal+", "scal-"};
	 std::vector<std::string> signal = {"3gauss", "fixed","scal+"};
	 //std::vector<std::string> signal = {"3gauss", "fixed", "scal","scal+", "scal-"};
	...
	//	divideBinWidth(hPtGen);*/
		...
		std::vector<std::string> labels_signal = {"Triple Gaussian", "Fixed Mean", "Increased $\\sigma$ scaling factor"};
