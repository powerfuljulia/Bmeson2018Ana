                ...
                if(skim)
                  {
                    ...
                    if(TrackInfo->pt[DInfo->rftk1_index[j]]<0.5) continue;
                    if(TrackInfo->pt[DInfo->rftk2_index[j]]<0.5) continue;
                    if((DInfo->svpvDistance[j]/DInfo->svpvDisErr[j])<2.5) continue;
                  //if(DInfo->alpha[j]>0.20) continue;
                  }
                if(DInfo->type[j]==(t+1))
                  {
